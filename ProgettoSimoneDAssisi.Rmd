...
# Fase 7.2: Confronto con un altro dataset (Phishing 4) strutturato in modo simile

test_set <- read.csv("Dataset/Phishing_URL_Dataset_4.csv", sep = ";")
...
# FASE 9.8: Applicazione del modello su dati sintetici
